                        ...
                        <Card.Body>
                            <Form noValidate validated={validated} onSubmit={(event) => handleSubmit(event)}>
                                ...
                                <Form.Group as={Row} className="mb-1" >
                                    ...
                                    <Col sm={9}>
                                    <InputGroup>
                                        <Form.Control type={cpasswordType}  placeholder="" required maxLength={8} minLength={5} name="cpassword" id="cpassword" value={formValues.cpassword} onChange={(e) => handleChange(e)}/>
